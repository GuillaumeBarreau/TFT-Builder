import { RESET_TRAITS, SORT_CHAMPIONS, ADD_CHAMPION, DELETE_CHAMPION, ADD_ITEM, DELETE_ITEM, MOVE_CHAMPION, CLEAR_BOARD, SHARE_BOARD } from './actionsTypes';
...
export const SHARE_BOARD_ACTION = (board) => ({
    type: SHARE_BOARD,
    board: board
});